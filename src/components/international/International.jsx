...
const PackageCard = ({ title, price, duration, originalPrice, features, buttonText }) => (
  <motion.div 
    className="bg-white p-6 rounded-lg p-6  shadow-md"
...
const TarotPackagesPageIndia = () => { 
  ...
  return (
    <div className="font-lato">
      ...
      <motion.div 
        className="min-h-screen bg-gray-100 bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center p-4"
