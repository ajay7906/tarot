...
const LoveRelationshipsGuidance = () => {
  const relationshipServices = [
    {
      title: "Understand your partner/love-interests",
    ...
    {
      title: "When will love happen and how?",
    ...
    {
      title: "Relationship Improvement and Everything Love Related",
    ...
    {
      title: "Dealing with Exes and Breakups",
  ...
  return (
    <div className="container  px-12 py-16 bg-gray-100 w-100">
      <h1 className="text-4xl font-bold text-center mb-16">Love & Relationships</h1>
...
export default LoveRelationshipsGuidance;