...
// import LoveImages from "../../../assets/healss.png";
// const Healing = () => {
//   return (
...
//             <span className="text-gray-800">Simplify Healing &</span><br />
//             <span className="text-gray-800">Meditation </span>
...
//                 src={LoveImages}
//                 alt="Tarot cards"
//                 className="w-full h-half object-contain "
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between">
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          ...
          <p className="text-gray-600 mb-8">
            Welcome to a space of healing and self-discovery. As a dedicated tarot reader, I offer a unique blend of tarot wisdom and healing practices to guide you on your journey to emotional and spiritual wellbeing..  Whether you're seeking to overcome past traumas, find balance in your present, or cultivate a more positive future, tarot can be a powerful tool in your healing process.
          </p>
          <div className="flex space-x-4">
            <button className="bg-teal-600 text-white px-6 py-2 rounded-full hover:bg-teal-700 transition duration-300">
              Book a Session
