...
const CreatePostForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //     'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAsImVtYWlsIjoicm95YWw5NjkwMTRAZ21haWwuY29tIiwiaWF0IjoxNzI4NTM0MDE2LCJleHAiOjE3Mjg1NTU2MTZ9.XRf4Kj-2z4xVr9x0olykfqRcyj6FdPz1R_JQCRU4ruA` // Include the token in the Authorization header
      //   },
...
// EnrolledStudents component remains unchanged
// const EnrolledStudents = () => {
//   // ... (previous code)
// };
